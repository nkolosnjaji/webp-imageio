...
public class WebPPicture {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LibWebP.C_INT.withName("use_argb"),
        LibWebP.C_INT.withName("colorspace"),
        LibWebP.C_INT.withName("width"),
        LibWebP.C_INT.withName("height"),
        LibWebP.C_POINTER.withName("y"),
        LibWebP.C_POINTER.withName("u"),
        LibWebP.C_POINTER.withName("v"),
        LibWebP.C_INT.withName("y_stride"),
        LibWebP.C_INT.withName("uv_stride"),
        LibWebP.C_POINTER.withName("a"),
        LibWebP.C_INT.withName("a_stride"),
        MemoryLayout.sequenceLayout(2, LibWebP.C_INT).withName("pad1"),
        MemoryLayout.paddingLayout(4),
        LibWebP.C_POINTER.withName("argb"),
        LibWebP.C_INT.withName("argb_stride"),
        MemoryLayout.sequenceLayout(3, LibWebP.C_INT).withName("pad2"),
        LibWebP.C_POINTER.withName("writer"),
        LibWebP.C_POINTER.withName("custom_ptr"),
        LibWebP.C_INT.withName("extra_info_type"),
        MemoryLayout.paddingLayout(4),
        LibWebP.C_POINTER.withName("extra_info"),
        LibWebP.C_POINTER.withName("stats"),
        LibWebP.C_INT.withName("error_code"),
        MemoryLayout.paddingLayout(4),
        LibWebP.C_POINTER.withName("progress_hook"),
        LibWebP.C_POINTER.withName("user_data"),
        MemoryLayout.sequenceLayout(3, LibWebP.C_INT).withName("pad3"),
        MemoryLayout.paddingLayout(4),
        LibWebP.C_POINTER.withName("pad4"),
        LibWebP.C_POINTER.withName("pad5"),
        MemoryLayout.sequenceLayout(8, LibWebP.C_INT).withName("pad6"),
        LibWebP.C_POINTER.withName("memory_"),
        LibWebP.C_POINTER.withName("memory_argb_"),
        MemoryLayout.sequenceLayout(2, LibWebP.C_POINTER).withName("pad7")
