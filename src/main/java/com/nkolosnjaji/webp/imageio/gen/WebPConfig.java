...
public class WebPConfig {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LibWebP.C_INT.withName("lossless"),
        LibWebP.C_FLOAT.withName("quality"),
        LibWebP.C_INT.withName("method"),
        LibWebP.C_INT.withName("image_hint"),
        LibWebP.C_INT.withName("target_size"),
        LibWebP.C_FLOAT.withName("target_PSNR"),
        LibWebP.C_INT.withName("segments"),
        LibWebP.C_INT.withName("sns_strength"),
        LibWebP.C_INT.withName("filter_strength"),
        LibWebP.C_INT.withName("filter_sharpness"),
        LibWebP.C_INT.withName("filter_type"),
        LibWebP.C_INT.withName("autofilter"),
        LibWebP.C_INT.withName("alpha_compression"),
        LibWebP.C_INT.withName("alpha_filtering"),
        LibWebP.C_INT.withName("alpha_quality"),
        LibWebP.C_INT.withName("pass"),
        LibWebP.C_INT.withName("show_compressed"),
        LibWebP.C_INT.withName("preprocessing"),
        LibWebP.C_INT.withName("partitions"),
        LibWebP.C_INT.withName("partition_limit"),
        LibWebP.C_INT.withName("emulate_jpeg_size"),
        LibWebP.C_INT.withName("thread_level"),
        LibWebP.C_INT.withName("low_memory"),
        LibWebP.C_INT.withName("near_lossless"),
        LibWebP.C_INT.withName("exact"),
        LibWebP.C_INT.withName("use_delta_palette"),
        LibWebP.C_INT.withName("use_sharp_yuv"),
        LibWebP.C_INT.withName("qmin"),
        LibWebP.C_INT.withName("qmax")
    ).withName("WebPConfig");
